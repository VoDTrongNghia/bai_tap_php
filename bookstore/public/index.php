...
$router->post('/admin/orders/update/{id}', ['App\Controllers\AdminController', 'updateOrderStatus']);
$router->post('/admin/orders/delete/{id}', ['App\Controllers\AdminController', 'deleteOrder']);
...
if (isset($_GET['page'])) {
    ...
    switch ($page) {
        ...
        case 'orderDetail':
            ...
            $controller = new \App\Controllers\AdminController();
            $controller->orderDetail($orderId);
            exit;
        case 'users':
            $controller = new \App\Controllers\AdminController();
            $controller->users();
        ...
        case 'voucherDetail':
            ...
            $controller = new \App\Controllers\AdminController();
            $controller->voucherDetail($voucherId);
            exit;
        case 'addVoucher':
            $controller = new \App\Controllers\AdminController();
        ...
        case 'editVoucher':
            $voucherId = (int)($_GET['id'] ?? 0);
            $controller = new \App\Controllers\AdminController();
            $controller->editVoucher($voucherId);
            exit;
        case 'updateVoucher':
            $voucherId = (int)($_POST['id'] ?? 0);
            $controller = new \App\Controllers\AdminController();
            $controller->updateVoucher($voucherId);
            exit;
        case 'deleteVoucher':
            $voucherId = (int)($_GET['id'] ?? 0);
            $controller = new \App\Controllers\AdminController();
            $controller->deleteVoucher($voucherId);
            exit;
        case 'categories':
            $controller = new \App\Controllers\AdminController();
        ...
        case 'categoryDetail':
            ...
            $controller = new \App\Controllers\AdminController();
            $controller->categoryDetail($categoryId);
            exit;
        case 'addCategory':
            $controller = new \App\Controllers\AdminController();
