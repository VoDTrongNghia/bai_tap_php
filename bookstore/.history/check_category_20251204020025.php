...
try {
    ...
    echo "<h3>Kiểm tra cấu trúc bảng danh_muc:</h3>";
    $stmt = $pdo->query("DESCRIBE danh_muc");
    ...
    $stmt = $pdo->query("SELECT * FROM danh_muc LIMIT 3");
    if ($stmt->rowCount() > 0) {
        echo "<table border='1'>";
        ...
        echo "<p>Không có dữ liệu trong bảng danh_muc</p>";
    }
