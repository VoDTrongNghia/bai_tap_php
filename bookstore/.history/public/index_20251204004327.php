...
$router->get('/admin/categories/edit/{id}', ['App\Controllers\AdminController', 'categoryForm']);
...
try {
    ...
    // Debug: Check normalized path
    $routerInstance = new Router();
    $reflection = new ReflectionClass($routerInstance);
    $method = $reflection->getMethod('normalizePath');
    $method->setAccessible(true);
    $normalizedPath = $method->invoke($routerInstance, $_SERVER['REQUEST_URI']);
