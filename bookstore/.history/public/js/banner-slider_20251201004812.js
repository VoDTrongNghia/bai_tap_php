...
// Use function expression to avoid redeclaration issues
const BannerSlider = (() => {
    // Check if class already exists
    if (typeof window.BannerSlider !== 'undefined') {
        console.log('BannerSlider class already exists, returning existing class');
        return window.BannerSlider;
    }
    
    // Define the class
    class BannerSliderClass {
        constructor() {
    ...
    // Store class in window and return it
    window.BannerSlider = BannerSliderClass;
    return BannerSliderClass;
})();
