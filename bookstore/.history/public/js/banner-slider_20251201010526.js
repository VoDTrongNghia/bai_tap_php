...
// Use module pattern with dynamic initialization
(function(global) {
    'use strict';
    
    // Private constructor
    function BannerSliderConstructor() {
    ...
    // Private methods
    BannerSliderConstructor.prototype = {
        init: function() {
    ...
    function createBannerSlider() {
        return new BannerSliderConstructor();
    }
    
    // Export to global scope only if not exists
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (!global.bannerSliderInstance) {
            global.bannerSliderInstance = createBannerSlider();
        }
    });
