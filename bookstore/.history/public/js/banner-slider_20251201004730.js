...
// Check if class already exists to avoid redefinition
if (typeof BannerSlider !== 'undefined') {
    console.log('BannerSlider class already exists, skipping redefinition');
} else {
...
} // End of check for existing BannerSlider class
