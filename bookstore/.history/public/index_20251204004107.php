...
// Book management
$router->get('/books', ['App\Controllers\AdminController', 'books']);
$router->get('/books/create', ['App\Controllers\AdminController', 'create']);
$router->post('/books/save', ['App\Controllers\AdminController', 'saveBook']);
$router->get('/books/edit/(\d+)', ['App\Controllers\AdminController', 'edit']);
$router->post('/books/update', ['App\Controllers\AdminController', 'update']);
$router->post('/books/delete/(\d+)', ['App\Controllers\AdminController', 'delete']);
