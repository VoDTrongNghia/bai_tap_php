...
$router->post('/admin/books/create', ['App\Controllers\AdminController', 'create']);
$router->get('/admin/books/edit/{id}', ['App\Controllers\AdminController', 'edit']);
$router->post('/admin/edit', ['App\Controllers\AdminController', 'edit']);
$router->get('/admin/delete', ['App\Controllers\AdminController', 'delete']);
