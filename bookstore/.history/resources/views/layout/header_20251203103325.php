    ...
    <nav class="main-navigation">
        <div class="container">
            <ul class="nav-menu">
                ...
                <li><a href="<?= rtrim($baseUrl, '/') ?>/office-supplies">Văn phòng phẩm</a></li>
                <li><a href="<?= rtrim($baseUrl, '/') ?>/gifts">Quà tặng</a></li>
                <li><a href="<?= rtrim($baseUrl, '/') ?>/promotions">Khuyến mãi</a></li>
                <li><a href="<?= rtrim($baseUrl, '/') ?>/news">Tin tức – sự kiện</a></li>
            </ul>
        </div>
    </nav>
</header>
