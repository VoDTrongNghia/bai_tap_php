...
<head>
    ...
    <script src="<?= $baseUrl ?>assets/banner-slider.js" defer></script>
</head>
<body>
        ...
        <div class="container">
            <div class="header-content">
                ...
                <div class="header-actions">
                    <a href="<?= $baseUrl ?>cart" class="cart-link" id="cart-link">
                    ...
                    ?>
                        <div class="user-dropdown">
                            ...
                            <div class="user-dropdown-menu" id="userDropdownMenu">
                                ...
                                <a href="<?= $baseUrl ?>account" class="user-dropdown-item">
                                    <i class="fas fa-user"></i>
                                    <span>Tài khoản của tôi</span>
                                </a>
                                <a href="<?= $baseUrl ?>orders" class="user-dropdown-item">
                    ...
                    <?php else: ?>
                        <a href="<?= $baseUrl ?>login" class="account-link">
                            <i class="fas fa-user-circle"></i>
                            <span>Đăng nhập</span>
                        </a>
                    <?php endif; ?>
        ...
        <div class="container">
            <ul class="nav-menu">
                ...
                <li class="dropdown categories-dropdown">
                    <a href="<?= $baseUrl ?>books">Danh mục sách <i class="fas fa-chevron-down"></i></a>
                    <ul class="dropdown-menu">
                        <li class="dropdown-heading">Theo chủ đề</li>
                        <li><a href="<?= $baseUrl ?>books?category=van-hoc">Văn học</a></li>
                        <li><a href="<?= $baseUrl ?>books?category=kinh-te">Kinh tế</a></li>
                        <li><a href="<?= $baseUrl ?>books?category=ky-nang">Kỹ năng sống</a></li>
                        <li><a href="<?= $baseUrl ?>books?category=tam-ly">Tâm lý - Học đường</a></li>
                        <li class="dropdown-heading">Theo ngôn ngữ</li>
                        <li><a href="<?= $baseUrl ?>books?category=english">English Books</a></li>
                        <li><a href="<?= $baseUrl ?>books?category=japanese">Japanese Books</a></li>
                        <li><a href="<?= $baseUrl ?>books?category=korean">Korean Books</a></li>
                        <li><a href="<?= $baseUrl ?>books?category=chinese">Chinese Books</a></li>
                    </ul>
                </li>
                <li class="dropdown">
