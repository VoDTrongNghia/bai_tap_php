...
<div class="books-page">
    ...
    <?php if (!empty($currentKeyword) || !empty($currentCategory) || !empty($currentType)): ?>
        <div class="filter-results-info">
            <p>
                <i class="fas fa-info-circle"></i>
                <?php if (!empty($currentType)): ?>
                    <?php if (!empty($currentKeyword) && !empty($currentCategory)): ?>
                        Tìm thấy <strong><?= count($books) ?></strong> sách trong danh mục <strong><?= htmlspecialchars($title) ?></strong> với từ khóa "<strong><?= htmlspecialchars($currentKeyword) ?></strong>" trong danh mục "<strong><?= htmlspecialchars($currentCategory) ?></strong>"
                    <?php elseif (!empty($currentKeyword)): ?>
                        Tìm thấy <strong><?= count($books) ?></strong> sách trong danh mục <strong><?= htmlspecialchars($title) ?></strong> với từ khóa "<strong><?= htmlspecialchars($currentKeyword) ?></strong>"
                    <?php elseif (!empty($currentCategory)): ?>
                        Tìm thấy <strong><?= count($books) ?></strong> sách trong danh mục <strong><?= htmlspecialchars($title) ?></strong> thuộc danh mục "<strong><?= htmlspecialchars($currentCategory) ?></strong>"
                    <?php else: ?>
                        Đang hiển thị <strong><?= count($books) ?></strong> sách trong danh mục <strong><?= htmlspecialchars($title) ?></strong>
                    <?php endif; ?>
                <?php else: ?>
                    <?php if (!empty($currentKeyword) && !empty($currentCategory)): ?>
