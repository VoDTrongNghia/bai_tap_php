...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Bookstore') ?> - <?= htmlspecialchars($appName) ?></title>
...
<!-- Frontend Logger -->
<script src="<?= $baseUrl ?>assets/js/frontend-logger.js"></script>
<script>
// Initialize logger
                    ...
                    <div class="books-grid" id="debug-grid-1">
                        ...
                        <?php foreach ($bestSellingBooks as $book): ?>
                            <div class="book-card">
                                ...
                                <?php if ($book->hasDiscount()): ?>
                                    <span class="discount-badge">-<?= $book->getFormattedDiscount() ?>%</span>
                                <?php endif; ?>
...
// Optimize banner slider performance
let bannerSlider = {
    currentSlide: 0,
    slides: [],
    dots: [],
    ...
    init: function() {
        ...
        // Start autoplay with longer interval for better performance
        this.startAutoPlay(6000);
        
        // Add event listeners
        document.getElementById('bannerPrev')?.addEventListener('click', () => this.prevSlide());
        document.getElementById('bannerNext')?.addEventListener('click', () => this.nextSlide());
    ...
    preloadImages: function() {
        // Preload next and previous slide images for smooth transitions
    ...
    showSlide: function(index) {
        ...
        // Preload images for new position
...
if (document.getElementById('bannerSlider')) {
    ...
    banner.addEventListener('mouseenter', () => bannerSlider.stopAutoPlay());
    banner.addEventListener('mouseleave', () => bannerSlider.startAutoPlay());
}
</script>
