        ...
        <div class="order-detail-grid">
            ...
            <div class="order-info-section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <span><?= htmlspecialchars($order['phuong_thuc_thanh_toan'] ?? 'COD') ?></span>
                    </div>
                    <div class="info-item">
                        <label>Tổng tiền:</label>
                        <span class="amount"><?= number_format($order['tong_tien'] ?? 0, 0, ',', '.') ?> đ</span>
                    </div>
                </div>
            </div>
            ...
            <div class="customer-info-section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        <label>Địa chỉ:</label>
                        <span><?= htmlspecialchars($order['dia_chi'] ?? 'N/A') ?></span>
                    </div>
                </div>
            </div>
        </div>
