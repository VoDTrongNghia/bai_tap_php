                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <?php if ($status === 'cho_xu_ly' || $status === 'pending'): ?>
                                    <button class="btn btn-sm btn-success" onclick="updateOrderStatus(<?= $order['id'] ?? $order['ma_don_hang'] ?>, 'dang_xu_ly')" title="Xác nhận">
                                        <i class="fas fa-check"></i>
                                    </button>
                                    <?php endif; ?>
                                    <?php if (in_array($status, ['cho_xu_ly', 'dang_xu_ly', 'pending', 'processing'])): ?>
                                    <button class="btn btn-sm btn-danger" onclick="updateOrderStatus(<?= $order['id'] ?? $order['ma_don_hang'] ?>, 'huy')" title="Hủy">
