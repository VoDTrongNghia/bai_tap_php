...
try {
    ...
    echo "<h3>Kiểm tra cấu trúc bảng voucher:</h3>";
    $stmt = $pdo->query("DESCRIBE voucher");
    ...
    $stmt = $pdo->query("SELECT * FROM voucher LIMIT 3");
    if ($stmt->rowCount() > 0) {
        echo "<table border='1'>";
        ...
        echo "<p>Không có dữ liệu trong bảng voucher</p>";
    }
