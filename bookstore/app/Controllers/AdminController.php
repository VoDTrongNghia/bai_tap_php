...
class AdminController
{
    ...
    public function categories(): void
    {
        ...
        View::render('admin/categories_list', [
            'title' => 'Quản lý Danh mục',
     ...
     */
    public function categoryDetail($categoryId): void
    {
        ...
        $bookCount = Category::getBookCount($categoryId);
        
        View::render('admin/categories_detail', [
            'title' => 'Chi tiết Danh mục #' . $categoryId,
            'category' => $category,
            'bookCount' => $bookCount
        ]);
    }
    ...
    public function addCategory(): void
    {
        ...
        View::render('admin/categories_add', [
    ...
    public function saveCategory(): void
    {
        ...
        try {
            ...
            if (strlen($data['ten_danh_muc']) > 150) {
                $errors[] = 'Tên danh mục không được vượt quá 150 ký tự';
            }

            if (Category::nameExists($data['ten_danh_muc'])) {
        ...
        $_SESSION['errors'] = $errors;
        header('Location: ' . BASE_URL . 'admin?page=addCategory');
        exit;
    }
    ...
    public function editCategory($categoryId): void
    {
        ...
        error_log("Edit Category - ID: $categoryId, Name: " . $category['ten_danh_muc']);
        error_log("Edit Category - Errors: " . print_r($errors, true));
        error_log("Edit Category - Success: " . $success);
        
        View::render('admin/categories_edit', [
            'title' => 'Chỉnh sửa Danh mục #' . $categoryId,
            'category' => $category,
            'errors' => $errors,
            'success' => $success
        ]);
    ...
    public function updateCategory($categoryId): void
    {
        ...
        error_log("Update Category - Starting with ID: $categoryId");
        error_log("Update Category - POST data: " . print_r($_POST, true));
        ...
        try {
            ...
            error_log("Update Category - Data: " . print_r($data, true));
            ...
            if (Category::nameExists($data['ten_danh_muc'], $categoryId)) {
                $errors[] = 'Tên danh mục này đã tồn tại';
            }

            error_log("Update Category - Validation errors: " . print_r($errors, true));

            if (empty($errors)) {
                if (Category::update($categoryId, $data)) {
                    $_SESSION['success'] = 'Cập nhật danh mục thành công!';
                    error_log("Update Category - Success redirecting to categories");
                    header('Location: ' . BASE_URL . 'admin?page=categories');
                    exit;
                } else {
        ...
        error_log("Update Category - Errors found, redirecting back: " . print_r($errors, true));
        $_SESSION['errors'] = $errors;
        header('Location: ' . BASE_URL . 'admin?page=editCategory&id=' . $categoryId);
        exit;
    }
    ...
    public function deleteCategory($categoryId): void
    {
        ...
        try {
            if (Category::delete($categoryId)) {
                ...
                $_SESSION['errors'] = ['Không thể xóa danh mục'];
            }
        } catch (Exception $e) {
    ...
    public function vouchers(): void
    {
        ...
        View::render('admin/vouchers_list', [
     ...
     */
    public function voucherDetail($voucherId): void
    {
        // Ép kiểu sang int để tránh lỗi
        ...
        if (empty($voucher)) {
            $_SESSION['errors'] = ['Voucher không tồn tại'];
            header('Location: ' . BASE_URL . 'admin?page=vouchers');
            exit;
        }
        
        View::render('admin/vouchers_detail', [
            'title' => 'Chi tiết Voucher #' . $voucherId,
            'voucher' => $voucher
        ]);
    }
    ...
    public function addVoucher(): void
    {
        ...
        View::render('admin/vouchers_add', [
    ...
    public function saveVoucher(): void
    {
        ...
        try {
            $data = [
                ...
                'kieu_giam' => $_POST['kieu_giam'] ?? 'percent',
            ...
            if ($data['giam_gia'] <= 0) {
                $errors[] = 'Giảm giá phải lớn hơn 0';
            }
            ...
            if (empty($data['ngay_bat_dau']) || empty($data['ngay_ket_thuc'])) {
            ...
            if (empty($errors)) {
                if (Voucher::insert($data)) {
                    $_SESSION['success'] = 'Thêm voucher thành công!';
                    header('Location: ' . BASE_URL . 'admin?page=vouchers');
                    exit;
                } else {
                    $errors[] = 'Không thể thêm voucher';
                }
            }
        } catch (Exception $e) {
        ...
        $_SESSION['errors'] = $errors;
        header('Location: ' . BASE_URL . 'admin?page=addVoucher');
        exit;
    }
     ...
     */
    public function editVoucher($voucherId): void
    {
        // Ép kiểu sang int để tránh lỗi
        $voucherId = (int) $voucherId;
        ...
        View::render('admin/vouchers_edit', [
            'title' => 'Chỉnh sửa Voucher #' . $voucherId,
            'voucher' => $voucher,
            'errors' => $errors,
            'success' => $success
        ]);
     ...
     * Cập nhật voucher
     */
    public function updateVoucher($voucherId): void
    {
        // Ép kiểu sang int để tránh lỗi
        $voucherId = (int) $voucherId;
        ...
        try {
            ...
            if (empty($errors)) {
                if (Voucher::update($voucherId, $data)) {
                    $_SESSION['success'] = 'Cập nhật voucher thành công!';
                    header('Location: ' . BASE_URL . 'admin?page=vouchers');
                    exit;
                } else {
                    $errors[] = 'Không thể cập nhật voucher';
                }
            }
        } catch (Exception $e) {
        ...
        $_SESSION['errors'] = $errors;
        header('Location: ' . BASE_URL . 'admin?page=editVoucher&id=' . $voucherId);
        exit;
    }
     ...
     * Xóa voucher
     */
    public function deleteVoucher($voucherId): void
    {
        // Ép kiểu sang int để tránh lỗi
        $voucherId = (int) $voucherId;
        ...
        try {
            if (Voucher::delete($voucherId)) {
                ...
                $_SESSION['errors'] = ['Không thể xóa voucher'];
            }
        } catch (Exception $e) {
            error_log("Error deleting voucher: " . $e->getMessage());
            $_SESSION['errors'] = ['Có lỗi xảy ra khi xóa voucher'];
        }
