        ...
        <div class="content-layout">
            ...
            <div class="main-area">
                ...
                <section class="books-section">
                    <div class="section-header">
                        <h2>Sách mới phát hành</h2>
                        <a href="<?= $baseUrl ?>index.php?page=books&type=new" class="view-all">Xem tất cả <i class="fas fa-arrow-right"></i></a>
                    </div>
                ...
                <section class="books-section">
                    <div class="section-header">
                        ...
                        <a href="<?= $baseUrl ?>index.php?page=books&type=discount" class="view-all">Xem tất cả <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div class="books-grid">
...
<section class="news-section">
    <div class="container">
        <div class="section-header">
            ...
            <a href="<?= $baseUrl ?>news" class="view-all">Xem tất cả <i class="fas fa-arrow-right"></i></a>
        </div>
        <?php if (isset($news) && !empty($news)): ?>
        <div class="news-grid">
            <?php foreach ($news as $article): ?>
            <article class="news-card">
                <img src="<?= $baseUrl ?>assets/images/books/<?= htmlspecialchars($article->image ?? 'datnhantam.jpg') ?>" alt="<?= htmlspecialchars($article->title ?? '') ?>">
                <div class="news-content">
                    <h3><a href="<?= $baseUrl ?>news/detail/<?= $article->id ?? 1 ?>"><?= htmlspecialchars($article->title ?? '') ?></a></h3>
