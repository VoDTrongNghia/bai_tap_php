...
<div class="admin-page">
    ...
    <?php endif; ?>
        ...
        <form method="POST" action="<?= $baseUrl ?>admin/books/update" class="admin-form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" id="price" name="price" class="form-input" step="1000" min="0" required 
                       value="<?= htmlspecialchars($_POST['price'] ?? $book?->price ?? 0) ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <?php if ($book && !empty($book?->coverImage)): ?>
                    <div class="current-image" style="margin-top: 12px;">
                        ...
                        <img src="<?= htmlspecialchars($book?->imageUrl ?? $book?->getImageUrl() ?? '') ?>" 
                             alt="<?= htmlspecialchars($book?->title ?? 'Sách') ?>" 
