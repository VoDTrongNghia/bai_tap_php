...
<div class="admin-dashboard">
    <div class="admin-card">
        <div class="admin-card-header">
            <h2 class="admin-card-title">Thêm Danh mục mới</h2>
        ...
        <form method="POST" action="<?= BASE_URL ?>admin?page=saveCategory" class="category-form">
            <div class="form-grid">
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="ten_danh_muc" name="ten_danh_muc" value="<?= htmlspecialchars($_POST['ten_danh_muc'] ?? '') ?>" required maxlength="150">
