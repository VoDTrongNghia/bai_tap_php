...
<div class="admin-page">
    <div class="admin-card">
        <div class="admin-card-header">
            <h2 class="admin-card-title">Thêm người dùng mới</h2>
        ...
        <form method="POST" action="<?= $baseUrl ?>admin/user-create" class="admin-form">
            ...
            <div class="form-group">
                ...
                <textarea id="dia_chi" name="dia_chi" class="form-textarea" rows="3"><?= htmlspecialchars($_POST['dia_chi'] ?? '') ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="vai_tro" name="vai_tro" class="form-select" required>
                    <option value="khach_hang" <?= ($_POST['vai_tro'] ?? 'khach_hang') === 'khach_hang' ? 'selected' : '' ?>>Khách hàng</option>
                    <option value="admin" <?= ($_POST['vai_tro'] ?? '') === 'admin' ? 'selected' : '' ?>>Quản trị viên</option>
                    <option value="quan_tri_vien" <?= ($_POST['vai_tro'] ?? '') === 'quan_tri_vien' ? 'selected' : '' ?>>Quản trị viên</option>
                </select>
            </div>
